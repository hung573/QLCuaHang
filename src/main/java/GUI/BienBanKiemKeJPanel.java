 ...
 * @author tranconghung
 */
public class BienBanKiemKeJPanel extends javax.swing.JPanel {
    ...
    /**
     * Creates new form BienBanKiemKeJPanel
     */
    public BienBanKiemKeJPanel() {
        initComponents();
        initTable();
        loadTable();
    }
    ...
    private void initComponents() {
        ...
        jPanel1.setPreferredSize(new java.awt.Dimension(984, 348));
        ...
        jtfSlTonKho.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                jtfSlTonKhoKeyPressed(evt);
            }
        });

        jtfChenhLech.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                jtfChenhLechKeyPressed(evt);
            }
        });

        jtfLydo.setAlignmentX(2.0F);
        jtfLydo.setAlignmentY(2.0F);
        jtfLydo.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jtfLydoActionPerformed(evt);
            }
        });
        ...
        btnClean.setIcon(new javax.swing.ImageIcon(System.getProperty("user.dir")+"\\src\\main\\java\\Image\\clean-icon2.png"));
        ...
        jtbBienBanKiemKe.setSelectionBackground(new java.awt.Color(204, 204, 204));
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addComponent(jtfTimKiem, javax.swing.GroupLayout.PREFERRED_SIZE, 356, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(18, 18, 18)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGap(18, 18, 18)
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addComponent(jtfChenhLech)
                                    .addComponent(jtfLydo, javax.swing.GroupLayout.DEFAULT_SIZE, 291, Short.MAX_VALUE)
                                    .addComponent(jtfSLThucThe)
                                    .addComponent(jtfSlTonKho, javax.swing.GroupLayout.Alignment.TRAILING))))
                        .addGap(13, 13, 13)))
                .addContainerGap())
        );
    ...
    private void btnTimKiemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTimKiemActionPerformed
        try {
            BienBanKiemKeBUS bienBanKiemKeBUS = new BienBanKiemKeBUS();
            List<BienBanKiemKe> list = bienBanKiemKeBUS.findBienBaKiemKe(jtfTimKiem.getText());
            if(list.isEmpty()){
                JOptionPane.showMessageDialog(this,"Biên bản kiểm kê không tồn tại" , "Cảnh báo", JOptionPane.ERROR_MESSAGE);
            }
            else{
                for(BienBanKiemKe bbkk : list){
                    jtfIDnhanvien.setText(String.valueOf(bbkk.getID()));
    ...
    private void jtfLydoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jtfLydoActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_jtfLydoActionPerformed
    ...
    private void jtfChenhLechKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jtfChenhLechKeyPressed
        
    }//GEN-LAST:event_jtfChenhLechKeyPressed

    private void jtfSlTonKhoKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jtfSlTonKhoKeyPressed
    ...
    }//GEN-LAST:event_jtfSlTonKhoKeyPressed
